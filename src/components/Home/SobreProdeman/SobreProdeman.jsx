	...
	return (
		...
		>
            ...
            <Image
                ...
                <Text as="p" fontSize="1.8rem" color="white" maxW="42.5rem" textAlign="center">Nuestra línea de productos creada para el mercado interno y con los estándares de calidad de un producto de exportación. Su constante crecimiento nos lleva a conquistar el mercado internacional con su sabor. </Text>
